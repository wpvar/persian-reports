...
class WOOPR_Admin extends WOOPR_Core
{
    ...
    public function add_menu()
    {
        ...
        add_menu_page(
            esc_attr__('گزارش فارسی و شمسی ووکامرس', 'persian-reports'),
            esc_attr__('گزارش فارسی', 'persian-reports'),
            'read_private_pages',
            'woopr-admin',
    ...
    public function main_template()
    {
        ...
        if(!parent::has_access()) {
            ...
            echo esc_attr__('اجازه دسترسی به این صفحه را ندارید. لطفا با مدیریت تماس بگیرید.', 'persian-reports');
            echo '</p>';
            return;
        }
    ...
    public function footer_text()
    {
        ...
        echo sprintf(esc_html__('برنامه‌نویسی و توسعه توسط %s', 'persian-reports'), '<a href="https://wpvar.com" target="_blank">وردپرس فارسی</a>');
        echo '</p>';
    }
    ...
    protected function alert($msg, $type)
    {
        if ($type == 'plugin') {
            ...
            $msg = sprintf(esc_html__('برای استفاده از افزونه گزارش فارسی٬ ابتدا باید افزونه %s را نصب و فعال کنید.', 'persian-reports'), '<a href="' . $url . '" target="_blank" id="wooprInstallPlugin">' . $msg . '</a>');
        ...
        if ($type == 'helper') {
            ...
            $msg = sprintf(esc_html__('برای استفاده بهتر از افزونه گزارش فارسی٬ ابتدا باید افزونه %s را نصب و فعال کنید.', 'persian-reports'), '<a href="' . $url . '" target="_blank" id="wooprInstallPlugin">' . $msg . '</a>');
    ...
    {
        $font = !empty(get_option('wpsh')['dashboard-font-default']) ? get_option('wpsh')['dashboard-font-default'] : 'IRANSansWeb, tahoma';
    ...
    {
        $reports_link = '<a href="' . get_admin_url() . 'admin.php?page=woopr-admin">' . esc_attr__('گزارش‌ها', 'persian-reports') . '</a>';
